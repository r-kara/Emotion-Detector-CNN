...
# Paths for our datasets: training set and testing set for all emotions: happy, neutral, surprise and focused
...
# Clean all images for all emotions: happy, neutral, surprise and focused
