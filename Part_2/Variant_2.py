...
def train_variant2_cnn(model, train_loader, val_loader, num_epochs=15, lr=0.001, patience=5, model_path='Models/final_model_variant2.pth'):
...
if __name__ == "__main__":
    ...
    # Train the model
    train_variant2_cnn(model, train_loader, val_loader)
